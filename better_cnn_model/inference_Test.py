"""
inference_test.py — Batch inference tester for better_cnn_model
...
# ── 5. BATCH TEST ────────────────────────────────────────────
print("\n" + "="*70)
print("  BATCH INFERENCE TEST — better_cnn_model")
...
for folder in class_folders:
    ...
    for file_path in sampled:
        ...
        # Map actual folder name to merged class name for fair comparison
        # M16 and M4 both belong to M-Family
